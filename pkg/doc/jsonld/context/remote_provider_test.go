...
func TestNewRemoteProvider(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		p, err := context.NewRemoteProvider("id", "endpoint")
...
func TestRemoteProvider_Contexts(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		p, err := context.NewRemoteProvider("id", "endpoint", context.WithHTTPClient(&mockHTTPClient{
